...
const LEFT = [
    ...
    'AIChat может анализировать изображения, аудио или видеоконтент, чтобы извлекать ценную информацию, обнаруживать объекты или закономерности, идентифицировать эмоции или настроения или предоставлять метаданные о медиафайлах.'
];
        ...
        <VStack align='center' gap="64" max>
            <VStack align='center' gap="64" className={cls.AboutPage}>
                <HStack max align='end' gap="64" className={classNames(cls.changeFlex, cls.team)}>
                    <VStack gap="16" style={{ paddingBottom: '1rem' }}>
                        ...
                        />
                        <Typography
                            text={t('В AIChat мы совершаем революцию в производительности и эффективности. В мире, где время имеет решающее значение, мы верим в упрощение ваших задач и предоставление вам возможности достичь большего.')}
                            align='left'
                            wrap
                        />
                        <Typography
            ...
            <VStack align='center' gap="64" className={cls.AboutPage}>
                <VStack gap="8" max align='center'>
                    ...
                    />
                    <Typography
                        text={t('Теперь наши Pandas есть в более чем 30 странах мира, использующих AIChat, и имея более чем пользователей менее чем за 3 недели и более 2100 запросов менее чем за 3 недели, мы являемся одним из самых быстрорастущих инструментов искусственного интеллекта в Европе. Наша удобная платформа для общения позволяет вам общаться с любыми файлами, медиафайлами, веб-сайтами и даже сканировать документ и мгновенно начинать с ним общение.')}
                        align='center'
                        wrap
                    />
                </VStack>
