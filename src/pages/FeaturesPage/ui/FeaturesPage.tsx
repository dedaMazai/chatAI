            ...
            <Card variant="greyOne" padding="54">
                <HStack gap="64" align='start' className={cls.changeFlex}>
                    <VStack gap="16">
                        ...
                        <Typography
                            size='m'
                            text={t('Panda What переходит по ссылкам, извлекает контент и собирает данные с веб-сайтов для создания всеобъемлющих индексов и сбора конкретной информации.')}
                            wrap
                        />
                    </VStack>
